<?php
	...
	$sql = "SELECT count(idbaiviet) AS tongsodong FROM baiviet";
	$baiviet=mysql_query($sql);
	$arTSD = mysql_fetch_array($baiviet);
	...
	<div class="col-1">
		<div class="panel panel-default templatemo-content-widget white-bg no-padding templatemo-overflow-hidden">
			...
			<div class="templatemo-content-widget white-bg col-2">
				<a href="index.php?ac=tintuc_add" title="Add" class="templatemo-white-button">Add</a>
				...
				<table class="table table-striped table-bordered templatemo-user-table">
					...
					<tbody>
						<?php
							$sql="select * from baiviet limit $offset, $num";
							$baiviet=mysql_query($sql);
						...
						<tr>
							...
							<td><img src="../<?php echo $dong['anhminhhoa']; ?>" alt="<?php echo $tenbaiviet ?>" width="200px" height="130px" /></td>	
							<td><a href="index.php?ac=tintuc_edit&id=<?php echo $dong['idbaiviet'];?>" class="templatemo-edit-btn">Edit</a></td>
							<td><a href="modules/baiviet/xuly.php?id=<?php echo $dong['idbaiviet'];?>" class="templatemo-link">Delete</a></td>
						</tr>
						  <?php
						  }
						?>
				...
				<?php
					for ($i = 1; $i <= $sotrang; $i++){
						if ($i != $current_page) {
							?>
								<li><a href="?ac=tintuc&page=<?php echo $i?>"><?php echo $i?></a></li>
							<?php 
						} else {
							?>
