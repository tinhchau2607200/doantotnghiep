...
<div class="templatemo-content-widget white-bg">
	<h2 class="margin-bottom-10">Sửa ảnh</h2>
	<form action="modules/images/xuly.php?id=<?php echo $_GET['id']?>" method="post" id="suaimages">		
		...
		<div class="row form-group">
			<div class="col-lg-12 form-group">									 
				...
				<textarea name="chuthich" class="form-control" id="inputNote" rows="3"><?php echo $dong['tomtat'];?></textarea>
			</div>
		</div>
		
		<div class="form-group text-right">
		<input type="submit"  name="suaimages"  class="templatemo-blue-button" value="Sửa"/>
